...
final class FoodsViewController: UIViewController, UpdateDelegate {
    ...
    override func viewDidLoad() {
        ...
        searchBar.searchTextField.attributedPlaceholder = NSAttributedString(string: "Search For A Food".localized(), attributes: [NSAttributedString.Key.foregroundColor: UIColor( red: 255/255.0, green: 209/255.0, blue: 148/255.0, alpha: 1.0)])
    ...
    @IBAction func firstTabPressed(_ sender: UIButton) {
        ...
        recentsBottomConstraint.constant = 3.0
        favoritesBottomConstraint.constant = 3.0
//        frequentsButtonView.backgroundColor = ThemeColors.colorDarkOrange.associatedColor
        recentsButtonView.backgroundColor = ThemeColors.colorLightOrange.associatedColor
        favoritesButtonView.backgroundColor = ThemeColors.colorLightOrange.associatedColor
        frequentsButtonView.backgroundColor = .black
//        frequentsLabel.textColor = .black
        recentsLabel.textColor = UIColor.white
    ...
    @IBAction func secondTabPressed(_ sender: UIButton) {
        ...
        favoritesBottomConstraint.constant = 3.0
        frequentsButtonView.backgroundColor = ThemeColors.colorLightOrange.associatedColor
//        recentsButtonView.backgroundColor = ThemeColors.colorDarkOrange.associatedColor
        favoritesButtonView.backgroundColor = ThemeColors.colorLightOrange.associatedColor
        recentsButtonView.backgroundColor = .black
        frequentsLabel.textColor = UIColor.white
//        recentsLabel.textColor = .black
        favoritesLabel.textColor = UIColor.white
        tableView.reloadData()
    }
    ...
    @IBAction func thirdTabPressed(_ sender: UIButton) {
        ...
        frequentsButtonView.backgroundColor = ThemeColors.colorLightOrange.associatedColor
        recentsButtonView.backgroundColor = ThemeColors.colorLightOrange.associatedColor
//        favoritesButtonView.backgroundColor = ThemeColors.colorDarkOrange.associatedColor
        favoritesButtonView.backgroundColor = .black
        frequentsLabel.textColor = UIColor.white
        recentsLabel.textColor = UIColor.white
...
extension FoodsViewController: UITableViewDataSource, UITableViewDelegate, CellDelegate {
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        if favEnable && !searchEnable && foodSearchSuggestions.count == 0{
            ...
            self.tableView.separatorStyle = .singleLine
            cell.contentView.backgroundColor = UIColor( red: 255/255.0, green: 209/255.0, blue: 148/255.0, alpha: 1.0)
