...
//        label.makeLargeText(fontSize: 18)
    ...
    func setGoalCell(model: GoalCellModel){
        ...
        MyGoalCell.myGoalSettings = MyGoalSettingsController(goalValue: model.goalType , weightValue: model.weight, goalCalorieValue: calorieGoal, activenessValue: model.activeness, goalWeightValue: model.goalWeight, weeklyGoalValue: model.weeklyGoal
        )
    }
