...
class InstructionsViewController: UIViewController {
    ...
    private func setupTableView() {
        ...
        tableView.separatorColor = ThemeColors.colorLightOrange.associatedColor
    }
...
extension InstructionsViewController: UITableViewDataSource, UITableViewDelegate {
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        cell.backgroundColor = ThemeColors.colorLightOrange.associatedColor
    ...
    func tableView(_ tableView: UITableView, viewForHeaderInSection section: Int) -> UIView? {
        ...
        headerView.backgroundColor = ThemeColors.colorLightOrange.associatedColor
        return headerView
    }
}
